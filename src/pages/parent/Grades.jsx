...
import { FiBook, FiTrendingUp, FiTrendingDown, FiAward, FiFileText, FiUser } from 'react-icons/fi';
...
const ParentGrades = () => {
  ...
  const subjects = ['all', 'Mathematics', 'Physics', 'Chemistry', 'English Literature', 'History', 'Science'];

  // Mock data for each child
  const gradesData = {
    1: [ // John Doe
      {
        id: 1,
    ...
    2: [ // Jane Doe
      {
        ...
        breakdown: [
          { type: 'Mid-Term Exam', score: 95, maxScore: 100, weight: '25%', date: '2024-01-09' },
          { type: 'Final Exam', score: 94, maxScore: 100, weight: '25%', date: '2024-01-19' },
          { type: 'Assignments (Avg)', score: 96, maxScore: 100, weight: '30%', date: 'Various' },
          { type: 'Quizzes (Avg)', score: 93, maxScore: 100, weight: '20%', date: 'Various' }
        ],
        trend: 'up',
        previousGrade: 92.0,
        classAverage: 85.5,
      ...
      },
      {
        ...
        breakdown: [
          { type: 'Mid-Term Exam', score: 92, maxScore: 100, weight: '20%', date: '2024-01-10' },
          { type: 'Final Exam', score: 93, maxScore: 100, weight: '20%', date: '2024-01-20' },
          { type: 'Assignments (Avg)', score: 94, maxScore: 100, weight: '25%', date: 'Various' },
          { type: 'Quizzes (Avg)', score: 91, maxScore: 100, weight: '15%', date: 'Various' },
          { type: 'Practical (Avg)', score: 95, maxScore: 100, weight: '20%', date: 'Various' }
        ],
        trend: 'up',
        previousGrade: 90.5,
  ...
  const grades = gradesData[selectedChild] || [];
  ...
  const totalGPA = grades.length > 0 ? (grades.reduce((sum, g) => sum + g.gpa, 0) / grades.length).toFixed(2) : '0.00';
  const avgScore = grades.length > 0 ? (grades.reduce((sum, g) => sum + g.total, 0) / grades.length).toFixed(2) : '0.00';
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">View your children's academic performance</p>
        </div>
          ...
          <Card>
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">
                out of {selectedChild === 1 ? '30' : '28'} students
              </p>
            </div>
          </Card>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      {(grade.total - grade.classAverage).toFixed(1)}% above average
                    </p>
                  </div>
                  <div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <span className="text-gray-900">Your Child's Score</span>
